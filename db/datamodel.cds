...
context transaction {
    entity purchaseorder: common.Amount,cuid{
        ...
        Items: Composition of  many poitems on Items.PARENT_KEY = $self;  //in order to enable CRUDQ and draft enabled we need to use composition
    }
